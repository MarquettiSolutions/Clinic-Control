...
const publicFiles = new Set(['index.html','app.js','styles.css','firebase-config.js','patient.html','patient.js','patient.css','commerce.js','commerce.css','commerce-config.js','i18n.js','i18n-catalog.js']);
...
}).listen(3033,'127.0.0.1', () => console.log('Read-only preview: http://127.0.0.1:3033'));
